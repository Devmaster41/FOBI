...
def Fobi_TurnRight():
    ...
    Goal_position(2,368)
    while True:
        dxl_present_position, dxl_comm_result, dxl_error = packetHandler.read4ByteTxRx(portHandler, 2, 36)
        print(dxl_present_position)
        if dxl_present_position - 668 < 5:
            break
def Fobi_TurnLeft():
    print("Left")
    Goal_position(2,652)
...
def on_connect(client,userdata,flags,rc):
    ...
    client.subscribe("module/eyes/face/x")
    client.subscribe("module/eyes/face/y")
